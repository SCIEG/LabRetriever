...
ssd8 = c("11","15")		# genotye of suspected contributor of minor component 
calld8 = list(list(c("11","13","14","15"),c(NULL))) # the first list has the minor alleles that are not from an "assumed contributor," and can be any number of alleles, dependent on the R functions for which it will serve as input data.  Any alleles that 1) ARE from an assumed contributor, OR were 2) in a stutter position, AND 3) above the detection threshold, AND 4) below the stutter threshold would go where the word "NULL" is.
...
ssd21 = c("30","35")
#the 35 is not in the Butler Hisp database--if use minimal allele count, it doesn't change much, because allele is in masking slot--change is likely due to decreasing th efreq of other alleles.
calld21 = list(list(c("29","30","35"),c(NULL)))
...
ssd3 = c("14","15")		
calld3 = list(list(c("14","15","17"),c(NULL)))  
...
ssd13 = c("12","13")
calld13 = list(list(c("12","13"),NULL))
...
ssd16 = c("9","11")
calld16 = list(list(c("9","11"),c(NULL)))
...
ssd19 = c("14","15")
calld19 = list(list(c("14","15"),c(NULL)))
...
ssvwa = c("15","18")
callvwa = list(list(c("15","17","18"),c(NULL)))
...
ssd18 = c("12","16")
calld18 = list(list(c("12","16"),c(NULL)))
...
ssfga = c("19","21")
callfga = list(list(c("19","21"),NULL)) 
...
sink ("/Volumes/Inman Drive 2 1Tb/Dropbox/KKKN/Lab Retriever/Lab Retriever testing/Test 5/Bellard 3A 2Unk Identifiler R result.txt", append=TRUE)
"African American"

#write output file:
write.table(locus_LRs,"/Volumes/Inman Drive 2 1Tb/Dropbox/KKKN/Lab Retriever/Lab Retriever testing/Test 5/Bellard 3A 2Unk Identifiler R result.txt", sep="\t",col.names=FALSE, row.names=FALSE, append=TRUE)

write.table(locus_totals,"/Volumes/Inman Drive 2 1Tb/Dropbox/KKKN/Lab Retriever/Lab Retriever testing/Test 5/Bellard 3A 2Unk Identifiler R result.txt", sep="\t",col.names=FALSE, row.names=FALSE, append=TRUE)


date()

race = 3 # 1 = Afr-Am; 3 = Cauc; 5 = Hisp;
