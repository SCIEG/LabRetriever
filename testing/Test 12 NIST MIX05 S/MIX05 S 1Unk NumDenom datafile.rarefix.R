...
calld8 = list(list(c("12"),c("14","15"))) # the first list has the minor alleles that are not from an "assumed contributor," and can be any number of alleles, dependent on the R functions for which it will serve as input data.  Any alleles that 1) ARE from an assumed contributor, OR were 2) in a stutter position, AND 3) above the detection threshold, AND 4) below the stutter threshold would go where the word "NULL" is.
...
ssd21 = c("31.2","28")
calld21 = list(list(c("28"),c("27","31.2")))
...
ssd7 = c("10")
calld7 = list(list(c(NULL),c("9","10")))
...
sscsf = c("11","12")
callcsf = list(list(c(NULL),c("12","11"))) 
...
ssd16 = c("10","11")
calld16 = list(list(c("10"),c("11","12")))
...
ssd2 = c("21","22")
calld2 = list(list(c("21","22"),c("17","25"))) 
...
ssd19 = c("14","13")
calld19 = list(list(c(NULL),c("13","14")))
...
ssd18 = c("15","16")
calld18 = list(list(c("16"),c("12","15")))
...
ssfga = c("20","22")
callfga = list(list(c("20","22"),c("21","19"))) 
...
write.table(locus_LRs,"/Volumes/Inman Drive 2 1Tb/Dropbox/KKKN/Lab Retriever/Lab Retriever testing/Test 12 NIST MIX05 S/MIX05_S R DO_0 results.txt", sep="\t",col.names=FALSE, row.names=FALSE, append=TRUE)

write.table(locus_totals,"/Volumes/Inman Drive 2 1Tb/Dropbox/KKKN/Lab Retriever/Lab Retriever testing/Test 12 NIST MIX05 S/MIX05_S R DO_0 results.txt", sep="\t",col.names=FALSE, row.names=FALSE, append=TRUE)
