...
# Casename: NIST MIX05 G sample

# Item #: M

# LR # of unknown program: 1 Unk

dg = c(0.00) #Put the DO probs here
...
ssd8 = c("12")		# genotye of suspected contributor of minor component
calld8 = list(list(c("12"),c("15"))) # the first list has the minor alleles that are not from an "assumed contributor," and can be any number of alleles, dependent on the R functions for which it will serve as input data.  Any alleles that 1) ARE from an assumed contributor, OR were 2) in a stutter position, AND 3) above the detection threshold, AND 4) below the stutter threshold would go where the word "NULL" is.
...
ssd21 = c("27","28")
calld21 = list(list(c("27","28"),c("29","30")))
...
sscsf = c("11","13")
callcsf = list(list(c("13"),c("10","11"))) 
...
ssd13 = c("12")
calld13 = list(list(c(NULL),c("10","12")))
...
ssd16 = c("10","13")
calld16 = list(list(c("10","13"),c("12")))
...
ssd2 = c("21","25")
calld2 = list(list(c("21","25"),c("17","18"))) 
...
ssd19 = c("14.2","16.2")
calld19 = list(list(c("14.2","16.2"),c("11","15")))
...
ssvwa = c("15","17")
callvwa = list(list(c("17"),c("16","15")))
...
ssd18 = c("14","17")
calld18 = list(list(c("14"),c("12","17")))
...
ssfga = c("21","23")
callfga = list(list(c("23"),c("21","22"))) 
...
write.table(locus_LRs,"/Volumes/Inman Drive 2 1Tb/Dropbox/KKKN/Lab Retriever/Lab Retriever testing/Test 11 NIST MIX05_M/MIX05_M R DO_0 results.txt", sep="\t",col.names=FALSE, row.names=FALSE, append=TRUE)

write.table(locus_totals,"/Volumes/Inman Drive 2 1Tb/Dropbox/KKKN/Lab Retriever/Lab Retriever testing/Test 11 NIST MIX05_M/MIX05_M R DO_0 results.txt", sep="\t",col.names=FALSE, row.names=FALSE, append=TRUE)
