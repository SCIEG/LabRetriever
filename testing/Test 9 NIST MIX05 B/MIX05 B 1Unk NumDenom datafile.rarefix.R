...
dg = c(0.0) #Put the DO probs here
...
calld8 = list(list(c("13"),c("11","14"))) # the first list has the minor alleles that are not from an "assumed contributor," and can be any number of alleles, dependent on the R functions for which it will serve as input data.  Any alleles that 1) ARE from an assumed contributor, OR were 2) in a stutter position, AND 3) above the detection threshold, AND 4) below the stutter threshold would go where the word "NULL" is.
...
ssd21 = c("28","32.2")
calld21 = list(list(c("28","32.2"),c("30","31")))
...
ssd7 = c("8","10")
calld7 = list(list(c("8","10"),c("9","11")))
...
sscsf = c("7","10")
callcsf = list(list(c("7","10"),c("12","13"))) 
...
sstho = c("7","9.3")
calltho = list(list(c("7","9.3"),c("8","10")))  
...
ssd13 = c("12","14")
calld13 = list(list(c("12","14"),c("8","9")))
...
ssd16 = c("10","11")
calld16 = list(list(c("10","11"),c("9","12")))
...
ssd2 = c("17","21")
calld2 = list(list(c("17","21"),c("16","24"))) 
...
ssd19 = c("13")
calld19 = list(list(c("13"),c("12","14")))
...
ssvwa = c("15")
callvwa = list(list(c("15"),c("16","19")))
...
sstpo = c("9","10")
calltpo = list(list(c("9","10"),c("8","11")))
...
ssd18 = c("17","18")
calld18 = list(list(c("17","18"),c("12","15")))
...
ssd5 = c("8","13")
calld5 = list(list(c("8","13"),c("11","12")))  
...
ssfga = c("20","24")
callfga = list(list(c("20"),c("23","24"))) 
...
write.table(locus_LRs,"/Volumes/Inman Drive 2 1Tb/Dropbox/KKKN/Lab Retriever/Lab Retriever testing/Test 9 NIST MIX05 B/MIX05_B R AfAm results.txt", sep="\t",col.names=FALSE, row.names=FALSE, append=TRUE)

write.table(locus_totals,"/Volumes/Inman Drive 2 1Tb/Dropbox/KKKN/Lab Retriever/Lab Retriever testing/Test 9 NIST MIX05 B/MIX05_B R AfAm results.txt", sep="\t",col.names=FALSE, row.names=FALSE, append=TRUE)
